...
def main(opt):
    ...
    input_h, intput_w = 320, 320
    MODEL_PATH = '/home/yang/CenterFace/exp/ctdet/mobilev2_10/model_best.pth'
    opt = opts().init('--task {} --load_model {} --debug {} --input_h {} --input_w {}'.format(
        TASK, MODEL_PATH, debug, intput_w, input_h).split(' '))
    detector = detector_factory[opt.task](opt)

    out_onnx_path = "/home/yang/CenterFace/output/ctdet_mobile_.onnx"
    image = cv2.imread('/home/yang/CenterFace/readme/test.png')
