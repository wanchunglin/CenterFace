...
class FACEHP(data.Dataset):
  ...
  def __init__(self, opt, split):
    ...
    self.img_dir = os.path.join(self.data_dir, 'image_wider/images')
    
    if split == 'test':
      self.annot_path = os.path.join(
        self.data_dir, 'annotations_hp', 
    ...
    if split =='train':
        ...
        self.img_dir = os.path.join(self.data_dir, 'image_wider/images')                 # 这个在载入图片的时候有用
    """
    
    
    self.data_dir = os.path.join(opt.data_dir, 'mix')
    self.img_dir = os.path.join(self.data_dir, 'image_mix')     
    if split == 'test':
      self.annot_path = os.path.join(
        self.data_dir, 'hp', 
